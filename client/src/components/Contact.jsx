    ...
    <>
     {landlord && (
      <div className='flex flex-col gap-2'>
        <p className=''>Contact <span className='font-semibold'>{landlord.username}</span> for 
        ...
        className='w-full border p-3 rounded-lg' rows="2" value={message} onChange={onChange}></textarea>
